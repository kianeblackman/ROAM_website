        ...
        <div id='resources-wrapper'>
            <div id='resources-content'>
                <div className="resources-intro">
                    <h1>Resources</h1>
                    <p className="large">We are dedicated to the promotion of diversity and inclusion in both the
                        heritage world and the folk artistic movement. While this is not a complete
                        list, it is a starting point. We will be managing an inclusion portal on our
                        website in the near future. Please consider helping us by getting in contact
                        to share other groups - of any size - that can be added to this list. For our
                        most up-to-date list, as well as links to each source, click the link below.</p>
                </div>
